...
> 当前目标基线：DesktopShell v1.0.4（本轮修复完成后发布；发布前仍需真实 Windows 验收） · DSH 0.1.0-rc.7（默认，因 fresh npx 安装可靠性；rc.8 已实测 CLI/Web 兼容）/ rc.7 / rc.8 已测试；未来 DSH 按 CLI 能力 best-effort 兼容
